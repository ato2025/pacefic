...
function CreateBlRequestItemTextArea({title,actionType}:Props) {
   const [isFocused, setIsFocused] = useState(false)
   const [value,setValue] = useState<string>('')
   const dispatch = useAppDispatch();
  return (
    <div className={`relative  ${isFocused ?'my-10':'my-5' } w-full`}>
      <textarea
        ...
        onChange={(e)=>{
         ...
         dispatch(setBlRequestItem({type:actionType,payload:e.target.value}))
      }}
...
export default CreateBlRequestItemTextArea