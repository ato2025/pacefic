...
import ShippingUserFullNamePanel from "..";
...
<div>
          <div className="px-4 lg:px-24 flex justify-start items-center mt-5">
            <div className=" text-2xl text-white">Creator Admin :</div>
            <div className="text-gray-400 text-xl lg:text-2xl ms-5">{detail.UserFullName}</div>
          </div>
          <div className="px-4 lg:px-24 flex justify-start items-center mt-5">
          ...
          <div className="px-4 lg:px-24 flex justify-start items-center mt-9">
            <div className=" text-2xl text-white">Pdf :</div>
            <a
              href={`http://46.21.250.175:9090/media/bl/${detail.BLUrl}`}
              target="_blank"
          ...
          <div className="px-4 lg:px-24 flex justify-start items-center mt-9">
            <div className=" text-2xl text-white">Scanned Bl Img :</div>
            <a
